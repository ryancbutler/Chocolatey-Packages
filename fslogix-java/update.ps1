...
function global:au_GetLatest {
    ...
    $version = (get-item .\temp\x64\Release\FSLogixAppsJavaRuleEditorSetup.exe).VersionInfo.FileVersion
    $Latest.checksum32 = Get-FileHash temp\Win32\Release\FSLogixAppsJavaRuleEditorSetup.exe | % Hash
    $Latest.checksum64 = Get-FileHash temp\x64\Release\FSLogixAppsJavaRuleEditorSetup.exe| % Hash
